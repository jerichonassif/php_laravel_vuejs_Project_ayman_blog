                            ...
                            <div class="card-footer">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text attach_btn"><i
                                                class="fas icon-attach_file"></i></span>
                                    </div>
                                    <textarea name="" class="form-control type_msg" id="message"
                                              placeholder="Type your message..."></textarea>
                                    <div class="input-group-append" onclick="massegs()">
                                        <span class="input-group-text send_btn"><i class="fas icon-send-o"></i></span>
                                    </div>
                                </div>
                            </div>
                            <!--end form-->
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // var pusher = new Pusher('9f1b4129b94a51342350',{ authEndpoint: '/pusher_auth.php' }, {
            //     cluster: 'eu',
            //     forceTLS: true
            // });
            // var pusher = new Pusher('fe1bb0995d8628be4485', {authEndpoint: '/pusher_auth.php'}, {
            //     cluster: 'ap2',
            //     forceTLS: true
            // });
            //
            // var channel = pusher.subscribe('private-channel-chat');
            // channel.bind('event-chat', function (data) {
            //     alert(JSON.stringify(data));
            // });

            // Pusher.logToConsole = true;
            // let pusher = new Pusher('9f1b4129b94a51342350', {
            ...
            // var pusher = new Pusher('9f1b4129b94a51342350',
            ...
            // });
            //
            // Echo.private('private-channel-chat')
            //     .listen('event-chat', (e) => {
            //         console.log(e);
            //     });
        ...
        function userItem(data) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var script = '<div class="remove-item d-flex bd-highlight">'
                        + '<div class="img_cont">'
                        // + '<img '
                    ...
                    $('#user' + data.id).addClass('active');
                    datam = data;
                    $('.remove-item').remove();
                    $('.msg_head').append(script);
                }
            });
        };
        ...
        function massegs() {
            ...
            $.ajax({
                    ...
                    data: {
                        ...
                        receiver_id: datam['id'],
                    },
                    success: function (res) {
                        localStorage.setItem('aaa', datam['id']);
